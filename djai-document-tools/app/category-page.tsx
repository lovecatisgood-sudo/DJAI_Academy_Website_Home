...
export function SuiteHeader({ category, language, tool }: { category: Category; language: Language; tool?: ToolDefinition }) {
  ...
  return <header className="suite-header">
    <a className="suite-brand" href={categoryHref(category, language)}><Image src="/tools/djai-assets/djai-academy-logo.webp" alt="DJAI Academy" width={84} height={62} /><span><strong>DJTools</strong><small>{en ? "Free browser tools" : "เครื่องมือฟรีบน browser"}</small></span></a>
