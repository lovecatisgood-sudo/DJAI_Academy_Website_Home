...
export const metadata = {
  title: "Lịch học và nội dung AI Masterclass | DJAI",
  ...
  openGraph: { title: "Lịch học và nội dung AI Masterclass của DJAI", description: "Một ngày thực hành để đi từ ý tưởng đến bản demo sản phẩm.", url: "/course/detail/vi/", images: ["/course/assets/community2-display.webp"], type: "website", locale: "vi_VN" }
};
...
export default function VietnameseCourseDetailPage() {
  return <main id="home" className="site-shell course-detail-page" lang="vi"><SiteHeader locale="vi" /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
    <section className="detail-hero"><img src="/course/assets/community2-display.webp" alt="Workshop thực hành của DJAI Academy" /><div className="detail-hero-shade" /><div className="detail-hero-content"><div className="pill"><span className="pulse-dot" />22 tháng 8, 2026 | 09:30–16:00</div><span className="detail-kicker">AI MASTERCLASS THỰC HÀNH MỘT NGÀY</span><h1>Lịch học, nội dung và kết quả của workshop</h1><p>Xem lịch trình đầy đủ, nội dung bốn phần và kết quả dự án trước khi giữ chỗ: từ chọn bài toán, lập kế hoạch, xây, kiểm tra đến triển khai bản demo.</p><div className="hero-actions"><CourseRegistrationLink>Giữ chỗ <ArrowRight size={18} /></CourseRegistrationLink><a className="button button-ghost" href="#schedule">Xem lịch trình</a></div><p className="account-entry-note">Cần tài khoản DJAI School miễn phí hoặc gói cao hơn. <a href={courseRegistrationUrls.login}>Đã có tài khoản? Đăng nhập</a></p></div></section>
