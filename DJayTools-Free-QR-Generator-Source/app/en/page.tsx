...
export default function Home({ toolSlug, pageCopy }: { toolSlug?: QrToolSlug; pageCopy?: QrPageCopy }) {
  ...
  return (
    <main>
      ...
      <ToolDiscoveryFooter language="en" currentTool={toolSlug} />
      <footer>
        ...
        <nav className="footer-links" aria-label="DJAI and partner links">
          <div>
            ...
            <a href="https://www.djai.academy/development/en/" target="_blank" rel="noopener noreferrer">Develop With Us</a>
          </div>
          <div>
