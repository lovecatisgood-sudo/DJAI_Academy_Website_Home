...
const categories = [
  { id: "mobile", label: "Ứng dụng di động", title: "Công cụ tài liệu dùng hằng ngày", summary: "Sản phẩm Android gom thao tác quét, quản lý tệp, chỉnh sửa PDF, ký tên và tạo QR vào một luồng gọn.", projects: [
    ["Cam PDF Scanner: Sign & QR", "/apps/cam-pdf/home.png", "Không gian làm việc tài liệu trên Android: quét và sắp xếp tệp, nhập PDF, DOCX và ảnh, chỉnh sửa, ký, xuất tệp và xử lý QR.", ["Android", "Quét tài liệu", "PDF và QR"], "/Cam_PDF_Scan_Signer_QR-Gen/"]
  ]},
  { id: "website", label: "Website", title: "Website cho doanh nghiệp, sản phẩm và thương hiệu địa phương", summary: "Từ website B2B đến trang dịch vụ và landing page, mỗi dự án tập trung vào thông tin người dùng cần để đưa ra bước tiếp theo.", projects: [
    ...
    ["Siamese Cat Hotel", "/portfolio/optimized/websites/Siamese_Cat_Hotel.webp", "Website dịch vụ lưu trú cho mèo, mở rộng hệ sinh thái thương hiệu với luồng tìm hiểu và đặt dịch vụ rõ ràng.", ["Dịch vụ", "Ý định đặt chỗ"], null],
