...
const routes = [
  {
    ...
    href: "https://djai.academy/course/",
    action: "ดูคอร์สเรียน"
  },
  {
    eyebrow: "เข้าร่วม",
    ...
    href: "https://djai.academy/community/",
    ...
    <>
      ...
      <main id="top">
          ...
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <a className="button primary" href="https://djai.academy/community/">
                  เข้าร่วมชุมชนฟรี
                </a>
                <a className="button secondary" href="https://djai.academy/course/">
                  ดูคอร์สเรียน
                </a>
                <a className="button ghost" href="https://djai.academy/development/th/">
        ...
        <section className="section tools-section">
          ...
          <a className="button secondary dark" href="https://djai.academy/tools/th/">
            เปิดเครื่องมือฟรี
          </a>
        </section>
        ...
        <section className="section service-section">
          <div className="service-panel">
            ...
            <div className="hero-actions compact">
              <a className="button primary" href="https://djai.academy/service/th/">
                ดูบริการ
              </a>
              <a className="button ghost light" href="https://djai.academy/portfolio/th/">
                ดูผลงาน
              </a>
            </div>
          </div>
        ...
        <section className="final-cta">
          ...
          <div className="hero-actions compact">
            ...
            <a className="button secondary" href="https://djai.academy/development/th/">
              วิธีการพัฒนา
            </a>
          </div>
        </section>
