...
export default function DeleteCamPdfAccountPage() {
  return <><SiteHeader locale="en" currentRoute="camPdf" languageHrefs={{ "zh-CN": `${APP_PATH}zh-cn/delete-account/`, "zh-TW": `${APP_PATH}zh-tw/delete-account/` }} /><main className={styles.page}>
    ...
    <article className={styles.content}>
      ...
      <section><h2>Delete inside the app</h2><p>Open Cam PDF Scanner: Sign &amp; QR → Me → Account and consent → Delete account. Review the warning and confirm Delete account. The app signs you out after the request succeeds.</p></section>
