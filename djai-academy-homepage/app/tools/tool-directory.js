const categoryData = [
  ...
  },
  {
    ...
    tools: [
      ...
      ["video-converter", "แปลงวิดีโอ", "เลือก MP4 MOV WebM MKV หรือ AVI", "Video Converter", "Convert between common video formats."],
      ["mkv-to-mp4", "MKV เป็น MP4", "สร้าง MP4 ที่เปิดและแชร์ง่ายขึ้น", "MKV to MP4", "Create an MP4 that is easier to play and share."],
      ["avi-to-mp4", "AVI เป็น MP4", "แปลงวิดีโอจาก format เก่า", "AVI to MP4", "Convert legacy AVI video to MP4."],
      ["mp4-to-mov", "MP4 เป็น MOV", "เตรียมวิดีโอสำหรับ workflow ที่ต้องใช้ MOV", "MP4 to MOV", "Prepare video for workflows that require MOV."],
      ...
      ["video-cutter", "ตัดวิดีโอ", "กำหนดเวลาเริ่มและจบก่อน export", "Video Cutter", "Choose exact start and end times before export."],
      ["compress-video", "บีบอัดวิดีโอ", "ลดขนาดด้วยคุณภาพ resolution หรือเป้าหมาย", "Compress Video", "Reduce size by quality, resolution, or target."],
      ["compress-video-to-10mb", "วิดีโอใกล้ 10 MB", "เตรียมไฟล์สำหรับ limit ขนาดเล็ก", "Compress Video to 10 MB", "Prepare video for a small upload limit."],
      ["compress-video-to-25mb", "วิดีโอใกล้ 25 MB", "ลดไฟล์ให้ใกล้เป้าหมาย 25 MB", "Compress Video to 25 MB", "Reduce video toward a 25 MB target."],
      ["compress-video-to-50mb", "วิดีโอใกล้ 50 MB", "ลดไฟล์ให้ใกล้เป้าหมาย 50 MB", "Compress Video to 50 MB", "Reduce video toward a 50 MB target."],
      ["compress-video-to-100mb", "วิดีโอใกล้ 100 MB", "ลดไฟล์ให้ใกล้เป้าหมาย 100 MB", "Compress Video to 100 MB", "Reduce video toward a 100 MB target."],
      ["video-cropper", "ครอปวิดีโอ", "ครอปกลางตามอัตราส่วนยอดนิยม", "Video Cropper", "Center-crop video to common aspect ratios."],
      ["video-resizer", "Resize วิดีโอ", "ปรับความกว้างพร้อมรักษาอัตราส่วน", "Video Resizer", "Change video width while preserving its ratio."],
      ["video-merger", "รวมวิดีโอ", "เรียงหลายคลิปแล้ว export เป็น MP4", "Video Merger", "Order several clips and export one MP4."],
      ["video-to-gif", "วิดีโอเป็น GIF", "เลือกช่วง ความกว้าง และ FPS", "Video to GIF", "Choose a clip, width, and frame rate."],
      ["gif-to-mp4", "GIF เป็น MP4", "สร้างวิดีโอที่แชร์ได้จาก GIF", "GIF to MP4", "Create a shareable MP4 from an animated GIF."],
      ["remove-audio-from-video", "ลบเสียงจากวิดีโอ", "ส่งออก MP4 ที่ไม่มี audio stream", "Remove Audio from Video", "Export an MP4 without an audio stream."],
      ["add-audio-to-video", "ใส่เสียงในวิดีโอ", "แทนที่หรือผสมเสียงกับวิดีโอ", "Add Audio to Video", "Replace or mix audio with a video."],
      ["video-speed-changer", "ปรับความเร็ววิดีโอ", "เปลี่ยนความเร็ว 0.5× ถึง 2×", "Video Speed Changer", "Change playback speed from 0.5× to 2×."],
      ["extract-frames-from-video", "ดึงภาพจากวิดีโอ", "ส่งออก JPG หรือ PNG พร้อม ZIP", "Extract Frames from Video", "Export JPG or PNG frames with an optional ZIP."],
      ["rotate-video", "หมุนวิดีโอ", "หมุน 90 หรือ 180 องศา", "Rotate Video", "Rotate video by 90 or 180 degrees."]
    ]
  },
  {
