...
const corePaths = [
  ...
  "/siamese_cat/en/", "/siamese_cat/vi/", "/siamese_cat/dev/", "/siamese_cat/dev/en/", "/siamese_cat/dev/vi/", "/siamese_cat/dev/course/", "/siamese_cat/dev/course/th/", "/siamese_cat/dev/course/vi/", "/siamese_cat/dev/blog/",
  "/siamese_cat/dev/blog/en/", "/siamese_cat/dev/blog/vi/", "/siamese_cat/dev/blog/vi/vibe-coded-free-scanner-app-real-product/", "/blog/", "/blog/en/", "/blog/vi/", "/Cam_PDF_Scan_Signer_QR-Gen/", "/Cam_PDF_Scan_Signer_QR-Gen/vi/",
...
function localized(base, slugs = []) {
  return [base, `${base}en/`, `${base}vi/`, ...slugs.flatMap((slug) => [`${base}${slug}/`, `${base}${slug}/en/`, `${base}${slug}/vi/`])];
}

const staticPaths = [
  ...corePaths,
  ...localized("/tools/qrgen/", qrTools),
  ...localized("/tools/resizeimg/", imageTools),
  ...localized("/tools/PDFTools/", pdfTools),
  ...localized("/tools/media/", mediaTools),
  ...Object.entries(suiteTools).flatMap(([category, slugs]) => localized(`/tools/${category}/`, slugs))
];
