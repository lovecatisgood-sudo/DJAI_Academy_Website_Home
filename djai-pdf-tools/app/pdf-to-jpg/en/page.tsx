...
const alias = pdfSeoAliases["pdf-to-jpg"];
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: pdfAliasHref(alias, "en"), languages: { th: pdfAliasHref(alias, "th"), en: pdfAliasHref(alias, "en"), vi: "/tools/PDFTools/pdf-to-jpg/vi/", "x-default": pdfAliasHref(alias, "th") } },
...
export default function PdfToJpgEnglishPage() {
