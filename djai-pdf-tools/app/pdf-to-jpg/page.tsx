...
export const metadata: Metadata = {
  ...
  alternates: { canonical: pdfAliasHref(alias, "th"), languages: { th: pdfAliasHref(alias, "th"), en: pdfAliasHref(alias, "en"), vi: "/tools/PDFTools/pdf-to-jpg/vi/", "x-default": pdfAliasHref(alias, "th") } },
