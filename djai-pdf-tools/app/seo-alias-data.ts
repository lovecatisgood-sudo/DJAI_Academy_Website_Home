...
export const pdfSeoAliases: Record<string, PdfSeoAlias> = {
  ...
  "pdf-to-png": {
    ...
    copy: {
      ...
      en: { slug: "pdf-to-png", label: "PDF to PNG", title: "Convert PDF to PNG Online Free", short: "Export every PDF page as a high-quality PNG and download an image or ZIP.", description: "Convert PDF pages to lossless PNG images free without uploading. Download one PNG or all pages together in a ZIP.", guide: { title: "How to convert PDF pages to PNG", intro: "PNG is useful for crisp document text, graphics, and lossless editing workflows.", steps: ["Choose a PDF file", "Keep PNG selected and choose a resolution", "Download the PNG image or ZIP"] } }
    }
  },
  "extract-pdf-pages": {
